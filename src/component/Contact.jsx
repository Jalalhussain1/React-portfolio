                    ...
                    <div className='space-y-6 sm:space-y-8 animate-fade-in-left'>
                        ...
                        <div className='space-y-4 sm:space-y-6'>
                            <div className='flex items-center space-x-3 sm:space-x-4 p-3 sm:p-4 bg-transparent rounded-lg border border-[#0ef]/30 hover:border-[#0ef] hover-lift shadow-[0_0_20px_rgba(0,238,255,0.3)] transition-all duration-300'>
                                ...
                                <div className='min-w-0'>
                                    ...
                                    <p className='text-white text-sm sm:text-base break-all'>hussainjalalcs@gmail.com</p>
                                </div>
                            </div>
                            ...
                            <div className='flex items-center space-x-3 sm:space-x-4 p-3 sm:p-4 bg-transparent rounded-lg border border-[#0ef]/30 hover:border-[#0ef] hover-lift shadow-[0_0_20px_rgba(0,238,255,0.3)] transition-all duration-300'>
                                ...
                                <div className='min-w-0'>
                                    ...
                                    <p className='text-white text-sm sm:text-base'>Available for remote work worldwide</p>
                                </div>
                            </div>
                            ...
                            <div className='flex items-center space-x-3 sm:space-x-4 p-3 sm:p-4 bg-transparent rounded-lg border border-[#0ef]/30 hover:border-[#0ef] hover-lift shadow-[0_0_20px_rgba(0,238,255,0.3)] transition-all duration-300'>
                                ...
                                <div className='min-w-0'>
                                    ...
                                    <p className='text-white text-sm sm:text-base'>Usually within 24 hours</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className='pt-4 sm:pt-6'>
                            ...
                            <div className='flex space-x-3 sm:space-x-4'>
                                ...
                                >
                                    <svg className='w-5 h-5 sm:w-6 sm:h-6 text-white hover:text-[#0ef] transition-colors duration-300' fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className='animate-fade-in-right'>
                        <form ref={form} onSubmit={sendEmail} className='space-y-4 sm:space-y-6 bg-transparent rounded-xl p-6 sm:p-8 border border-[#0ef]/30 shadow-[0_0_20px_rgba(0,238,255,0.3)]'>
                            <div className='text-center mb-6 sm:mb-8'>
                                ...
                                <p className='text-white text-sm sm:text-base'>I'd love to hear from you!</p>
                            </div>
